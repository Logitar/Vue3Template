...
internal class UpdateRealmGraphType : InputObjectGraphType<UpdateRealmInput>
{
  public UpdateRealmGraphType()
  {
    Name = nameof(UpdateRealmInput);
    Description = "The data used to update the realm.";
